...
def restart(update, context):
    restart_message = sendMessage("✔️Bot Restarting•••", context.bot, update.message)
    if Interval:
        Interval[0].cancel()
        Interval.clear()
    clean_all()
...
help_string = '''
<b><a href='https://t.me/Opleech_updates_v1'>WD Zone</a></b> - The Ultimate Telegram MIrror-Leech Bot to Upload Your File & Link in Google Drive & Telegram
...
def main():
    ...
    if ospath.isfile(".restartmsg"):
        ...
        msg += f"⇛ Hey Follow ⇛ https://t.me/Opleech_updates_v1\n"
        ...
        text += f"⇛ Hey Follow ⇛ https://t.me/Opleech_updates_v1\n"
