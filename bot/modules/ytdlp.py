...
def _ytdl(bot, message, isZip=False, isLeech=False):
    ...
    if BOT_PM and message.chat.type != 'private':
        try:
            msg1 = f'✔️Added your Requested link to Download\n'
    ...
    if 'entries' in result:
        ...
        bmsg = sendMarkup('✔️Choose Playlist Videos Quality:', bot, message, YTBUTTONS)
    else:
        ...
        listener_dict[msg_id] = [listener, user_id, link, name, YTBUTTONS, opt, formats_dict]
        bmsg = sendMarkup('✔️Choose Video Quality:', bot, message, YTBUTTONS)
