...
def select(update, context):
    ...
    if len(context.args) == 1:
        ...
        msg = (
            "✔️Reply to an active /cmd which was used to start the qb-download or add gid along with cmd\n\n"
            + "✔️This command mainly for selection incase you decided to select files from already added torrent. "
        )
